 ...
 * <p>
 * Within a {@link HttpRequest} each request parameter should only exist once. This check is necessary to avoid e.g. SQL injection split over multiple request
...
public class GlobalRequestParameterPollutionFilter implements GlobalFilter, Ordered {
     ...
     *
     * @throws ParameterPollutionException is throw when a request parameter exists multiple times. The exception represents a http response with status
