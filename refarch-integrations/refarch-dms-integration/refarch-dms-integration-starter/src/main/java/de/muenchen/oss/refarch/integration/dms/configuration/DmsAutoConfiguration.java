package de.muenchen.oss.refarch.integration.dms.configuration;

import com.fabasoft.schemas.websvc.lhmbai_15_1700_giwsd.LHMBAI151700GIWSDSoap;
import de.muenchen.oss.refarch.integration.dms.adapter.out.fabasoft.FabasoftClientConfiguration;
import de.muenchen.oss.refarch.integration.dms.adapter.out.fabasoft.FabasoftOutAdapter;
import de.muenchen.oss.refarch.integration.dms.adapter.out.fabasoft.FabasoftProperties;
import de.muenchen.oss.refarch.integration.dms.application.port.out.CancelObjectOutPort;
import de.muenchen.oss.refarch.integration.dms.application.port.out.CreateDocumentOutPort;
import de.muenchen.oss.refarch.integration.dms.application.port.out.CreateFileOutPort;
import de.muenchen.oss.refarch.integration.dms.application.port.out.CreateProcedureOutPort;
import de.muenchen.oss.refarch.integration.dms.application.port.out.DepositObjectOutPort;
import de.muenchen.oss.refarch.integration.dms.application.port.out.ListContentOutPort;
import de.muenchen.oss.refarch.integration.dms.application.port.out.ReadContentOutPort;
import de.muenchen.oss.refarch.integration.dms.application.port.out.ReadMetadataOutPort;
import de.muenchen.oss.refarch.integration.dms.application.port.out.SearchFileOutPort;
import de.muenchen.oss.refarch.integration.dms.application.port.out.SearchSubjectAreaOutPort;
import de.muenchen.oss.refarch.integration.dms.application.port.out.UpdateDocumentOutPort;
