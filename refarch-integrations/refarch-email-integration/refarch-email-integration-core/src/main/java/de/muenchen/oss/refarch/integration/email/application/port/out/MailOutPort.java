package de.muenchen.oss.refarch.integration.email.application.port.out;

import de.muenchen.oss.refarch.integration.email.domain.model.Mail;
...
public interface MailOutPort {
    ...
    /// Sends a mail as provided by the [Mail] model.
    ///
    /// @param mail the fully constructed mail to send
    /// @throws de.muenchen.oss.refarch.integration.email.domain.exception.SendMailException if an error
    ///             occurs while constructing or sending the message
    ...
    ///            if `null` or the resource is not found, the mail is sent without a logo
    /// @throws de.muenchen.oss.refarch.integration.email.domain.exception.SendMailException if an error
    ///             occurs while constructing or sending the message
    ...
    /// @throws de.muenchen.oss.refarch.integration.email.domain.exception.SendMailException if an error
    ///             occurs while constructing or sending the message
    /// @throws de.muenchen.oss.refarch.integration.email.domain.exception.TemplateException if the
