package de.muenchen.refarch.s3.integration.client.configuration;
...
import de.muenchen.refarch.s3.integration.client.properties.S3IntegrationClientProperties;
import de.muenchen.refarch.s3.integration.client.properties.SupportedFileExtensions;
...
import de.muenchen.refarch.s3.integration.client.service.S3DomainProvider;
...
@ComponentScan(
        basePackages = {
                "de.muenchen.refarch.s3.integration.client"
        },
        excludeFilters = {
