...
This includes the SwaggerUI exposed by a running backend service, the Keycloak management UI, pgAdmin to check the application database and a possibility to open Vue DevTools in a separate browser tab.
