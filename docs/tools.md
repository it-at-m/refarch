...
The configuration also enables auto-merging of patch releases and pinning operations for GitHub Actions, NPM dependencies, Maven artifacts, image versions in `docker-compose.yml` and Dockerfile base images while keeping pinning of dependencies intact.
