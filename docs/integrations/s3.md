...
Integration for CRUD and other operations on a S3 storage.
...
After that the [S3OutPort](https://github.com/it-at-m/refarch/blob/main/refarch-integrations/refarch-s3-integration/refarch-s3-integration-core/src/main/java/de/muenchen/oss/refarch/integration/s3/application/port/out/S3OutPort.java) can be used for S3 operations (e.g. via autowiring, as port is available as bean).
